...
passengers <- read.csv(directory, skip=3, col.names=c("Country", "Total"))
...
using_networks <- read.csv(directory, skip=3, col.names=c("Country", "Total"))
...
education <- read.csv(directory, skip=2, col.names=c("Level","Age", "Total"))
...
education <- read.csv(directory, skip=2,
